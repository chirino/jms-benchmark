...
class BenchmarkProject(info: ProjectInfo) extends DefaultProject(info) {
  ...
  lazy val karaf_console = "org.apache.karaf.shell" % "org.apache.karaf.shell.console" % "2.1.0" intransitive()
  lazy val activemq = "org.apache.activemq" % "activemq-core" % "5.5.0"
  lazy val stompjms = "org.fusesource.stompjms" % "stompjms-client" % "1.0"
